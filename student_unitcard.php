...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            ?>
            <li class="item">
                <a href="student_subject_page.php?user_id=<?php echo $user['id']; ?>&department=MCA&semester=<?php echo $semester; ?>" class="menu-btn">
          ...
          for ($index = 0; $index <= 4; $index++) {
            $unitIndex = $index+1;
              ...
              <div class='title'>
                ...
                echo "<a href='student_session.php?user_id=".$user['id']."&subject_id=$subjectId&unit=$unitIndex&session=1&semester=$semester'>
                <button>session 1</button></a>";
                echo "<a href='student_session.php?user_id=".$user['id']."&subject_id=$subjectId&unit=$unitIndex&session=2&semester=$semester'>
