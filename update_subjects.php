  ...
  <div class="container">
    ...
    <form id="createform" method="post">
     <div class="banner">
      ...
      <div class="item">
        <div class="name-item">
        <button class="btn" onclick="location.href = 'add_subjects.php?user_id=<?php echo $user['id']; ?>';"><i class="fa fa-plus"></i> Add</button>
          
          <button class="btn" onclick="location.href = 'update_subjects.php?user_id=<?php echo $user['id']; ?>';"><i class="fa fa-pen"></i> edit</button>
