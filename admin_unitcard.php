...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            ?>
            <li class="item">
                <a href="add_unit.php?user_id=<?php echo $user['id']; ?>&subject_id=<?php echo $subjectId; ?>" class="menu-btn">
            ...
            ?>
            <li class="item">
                <a href="admin_subjects.php?user_id=<?php echo $user['id']; ?>&department=MCA&semester=<?php echo $semester; ?>" class="menu-btn">
