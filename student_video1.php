...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sec-header">
            <div class="sidebar-btn"><a href="student_session.php?user_id=<?php echo $user['id']; ?>&subject_id=<?php echo $subid; ?>&unit=<?php echo $unit; ?>&session=<?php echo $session; ?>&semester=<?php echo $sem;?>" style="color:white";>
...
<div id='container' class='container'>
        ...
        <h1><?php echo $name ?> - Video Content</h1>
            <ul class="ulist">
                <!-- <li><a href='add_video.php?user_id=<?php echo $user['id']; ?>&subject_id=<?php echo $subject_id; ?>&session=<?php echo $session_id; ?>'>Add</a></li>
                <li><a href='#'>Edit</a></li> -->
              </ul>
        </div>
          <div class='content'>
