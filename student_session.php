...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            ?>
            <li class="item">
                <a href="student_unitcard.php?user_id=<?php echo $user['id']; ?>&department=MCA&subject_id=<?php echo $subId; ?>&semester=<?php echo $sem; ?>" class="menu-btn">
 ...
 <br>";
  ...
  <div class='card1'>
 <center>
 <a href='student_video1.php?user_id=$userId&subject_id=$subId&session_id=$sessionName&unit=$unitName&semester=$sem'>
...
<div class='card1'>
 <center>
 <a href='https://heyzine.com/flip-book/6201c2f11a.html#page/1'>
