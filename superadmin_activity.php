...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <li class="item">
                <a href="superadmin.php?user_id=<?php echo $user['id']; ?>" class="menu-btn">
...
VALUES ('$name','$rrn','$email','$department','$phonenumber','$year')";
        mysqli_query($conn, "insert into activity_log (date,name,action) values(NOW(),'$username','Added student $name')") or die(mysqli_error());
