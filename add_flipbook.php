  ...
  <div class="container">
    ...
    <form id="createform" method="post">
     <div class="banner">
      ...
      <div class="item">
        <p>Flipbook</p>
        <input type="textarea" name="flipbook" id="flipbook" placeholder="" required>
      </div>
      <div class="item">
        <p>session id</p>
        <input type="textarea" name="sessionid" id="sessionid" placeholder="" required>
      </div>
      <div class="item">
        <p>subject id</p>
        <input type="textarea" name="subjectid" id="subjectid" placeholder="" required>
      </div>
      <div class="btn-block">
...
//       });
          ...
          function createData()
          {
              ...
              function(e)
              {
                      ...
                      $.ajax({
                          type: "POST",
                          url: '/lmscres/flipbook_creation.php',
                          data:  $(this).serialize(),
